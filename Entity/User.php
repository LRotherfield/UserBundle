...
namespace Rothers\UserBundle\Entity;
...
class User implements AdvancedUserInterface, \Serializable
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Rothers\UserBundle\Entity\Role", inversedBy="users")
     */
    protected $roles;
     ...
     * Add roles
     *
     * @param Rothers\UserBundle\Entity\Role $role
     */
     ...
     * Set roles
     *
     * @param Array(Rothers\UserBundle\Entity\Role) $roles
     */
